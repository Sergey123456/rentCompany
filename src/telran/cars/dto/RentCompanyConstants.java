...
public interface RentCompanyConstants {
    ...
    String GET_ALL_CARS = "/car/getAll";//GET!!!
    String GET_CAR_DRIVERS = "/car/getDrivers";//GET!!!
    String GET_DRIVER_CARS = "/driver/getCars";//GET!!!
    String GET_ALL_RECORDS = "/common/getAllRecords";//GET!!!
    String GET_MODEL_PROFIT = "/common/getProfit";//GET!!!
    String GET_MOST_PROFITABLE_MODEL_NAMES = "/common/getMostProfitableModelNames";//GET!!!
    String GET_MOST_POPULAR_MODEL_NAMES = "/common/getMostPopularModelNames";//GET!!!
    String CLEAR = "/common/clear";//POST!!!
    String GET_RETURNED_RECORDS_BY_DATES = "/common/getRecordsByDate";//GET!!!
}
